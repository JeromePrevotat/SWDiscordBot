...
ABLT_CLASSES = {
	...
	'BOBAFETTSCION':['Tenacity Up', 'Armor Shred', 'AoE', 'DoT',
		'Tenacity Down', 'Potency Down', 'Breach', 'Leader: +Critical Avoid',
		'Leader: +Critical Damage', 'Leader: +Offense', 'Leader: +Speed',
		'Leader: +Mastery', 'Leader: +Max Health', 'Leader: +Max Protection',
		'Leader: +Potency', 'TM Gain', 'True Damage'],
	...
	'DARTHTALON':['Ability Block', 'CD Reduction', 'AoE', 'Buff Immunity',
		'Counter', 'Cleanse', 'Frenzy', 'TM Gain', 'Stealth'],
	'DARTHTRAYA':['Ability Block', 'Counter', 'Daze', 'Dispel',
		...
		'Health Steal Up'],
	'DASHRENDAR':['AoE', 'Assist', 'Critical Damage Down',
		'Critical Damage Up', 'Daze', 'Defense Down', 'Dispel',
		'TM Gain', 'Leader: +Max Health', 'Leader: +Speed',
		'Offense Up', 'Stealth', 'Stun', 'Leader: +Potency',
	...
	'EMPERORPALPATINE':['AoE', 'Counter', 'Dispel', 'TM Gain',
        ...
        'Shock', 'Leader: +Potency', 'Stats Stacking', 'Health Steal Up'],
	...
	'FENNECSHAND':['Armor Shred', 'AoE', 'Counter', 'TM Gain',
		'Leader: +Defense', 'Leader: +Max Health', 'Leader: +Max Protection',
		'Leader: +Offense', 'Offense Up'],
	...
	'GRIEVOUS':['AoE', 'Counter', 'Cleanse', 'TM Gain', 'Heal Immunity',
        ...
        'Target Lock', 'Bonus Turn', 'Health Steal Up'],
	...
	'GRANDMASTERYODA':['AoE', 'Foresight', 'TM Gain',
        ...
        'Protection Up', 'Leader: +Critical Chance',
		'Defense Penetration Up', 'Leader: +Critical Damage'],
	...
	'HANSOLO':['Counter', 'Evasion Up', 'TM Gain', 'TMR', 'Stun', 'Taunt',
    	'Critical Chance Up', 'Critical Damage Up', 'Bonus Attack',
		'Bonus Turn'],
	...
	'IDENVERSIOEMPIRE':['AoE', 'Assist', 'Counter', 'Critical Damage Up',
		'Dispel', 'TM Gain', 'Healing Immunity', 'Leader: +Critical Chance',
		'Leader: +Offense', 'Leader: +Speed', 'Protection Up', 'Revive',
		'Stun', 'Vulnerable', 'Mass Cleanse', 'Stats Stacking',
		'Leader: -Speed', 'Leader: +Max Health', 'Leader: +Max Protection',],
	'IG11':['AoE', 'Assist', 'Counter', 'Cleanse', 'DoT', 'Foresight',
        'Taunt', 'Tenacity Down', 'Heal', 'Health Steal Up'],
	...
	'JUHANI':['AoE', 'Counter', 'Mass Cleanse', 'Offense Up', 'Stealth',
        'Stun', 'Taunt', 'Stagger', 'Health Steal Up'],
	...
	'KUIIL':['Expose', 'TM Gain', 'Heal', 'Revive', 'Speed Down', 'Stun',
        'Burning', 'Shock'],
	'KYLEKATARN':['Ability Block', 'AoE',
		'Critical Chance Up', 'Defense Up', 'Mass Cleanse', 'TM Gain',
		'Potency Up', 'CD Reset', 'Speed Up', 'Heal'],
	...
	'LORDVADER':['Leader: +Speed', 'Leader: +Mastery', 'Leader: +Max Health',
		'Marked', 'Stats Stacking', 'Leader: +Critical Chance',
		'Leader: +Critical Damage', 'Critical Hit Immunity', 'Buff Immunity',
		'Healing Immunity', 'True Damage', 'AoE', 'Daze', 'DoT',
		'Ability Block', 'CD Increase'],
	...
	'MARAJADE':['AoE', 'Assist', 'Blind', 'Counter', 'Daze', 'Dispel',
		'TM Gain', 'Offense Down', 'Stagger', 'Stealth', 'Stun',
		'Tenacity Down', 'Vulnerable', 'Shock'],
	...
	'QIRA':['AoE', 'Assist', 'Counter', 'Daze', 'Dispel', 'Expose',
        ...
        'Mass Dispel', 'Stagger', 'Leader: +Offense', 'Health Steal Up'],
	...
	'SECONDSISTER':['Critical Damage Up', 'Dispel', 'TM Gain',
		'Leader: +Offense', 'TMR', 'Stun', 'Marked'],
	...
	'SNOWTROOPER':['Ability Block', 'AoE', 'TM Gain', 'Critical Damage Up',
        'CD Reduction'],
	'STARKILLER':['Shock', 'AoE', 'CD Reduction', 'Daze', 'Vulnerable',
		'Buff Immunity', 'Healing Immunity', 'Mass Cleanse', 'Dispel',
		'Mass Dispel', 'Counter', 'Bonus Turn', 'CD Reset', 'Stun', 'Heal',
		'Critical Hit Immunity', 'Damage Immunity'],
	...
	'VISASMARR':['AoE', 'Assist', 'Counter', 'Cleanse', 'Revive',
        'CD Reduction', 'Heal', 'Defense Penetration Up', 'Health Steal Up'],
...
BUFFS = ['Accuracy Up', 'Advantage', 'Critical Chance Up',
	...
	'Taunt', 'Tenacity Up', 'Translation', 'Retribution',
	'Health Steal Up', 'Protection Over Time']
...
LEADS = ['Leader: +Counter', 'Leader: +Critical Avoid',
	...
	'Leader: CD Reduction', 'Leader: Protection Up',
...
if __name__ == '__main__':
	...
	newChar = ['BOBAFETTSCION', 'DARTHTALON', 'DASHRENDAR', 'FENNECSHAND',
	'IDENVERSIOEMPIRE', 'KYLEKATARN', 'LORDVADER', 'MARAJADE', 'SECONDSISTER',
	'STARKILLER']
	with open(CWD + os.sep + 'trash', 'w+') as f:
		for character in charList:
			if (character['base_id'] in newChar):
