ABILITY_CLASSES = {
		...
		'ASAJVENTRESS':['AoE', 'Defense Down', 'Mass Dispel', 'TM Gain',
            'Leader: +Speed', 'TMR', 'Stun', 'Leader: +Offense', 'Heal', 'CD Reduction',
            'Stats Stacking'],
		'AURRA_SING':['Counter', 'TM Gain', 'Offense Up', 'CD Reset',
            'Stealth', 'Stun', 'Crit Chance Up', 'Bonus Turn',
		...
		'BB8':['Advantage', 'Assist', 'Counter', 'Daze', 'Mass Cleanse',
            ...
            'Taunt', 'Tenacity Down', 'Crit Chance Up', 'Crit Damage Up'],
		'BIGGSDARKLIGHTER':['Assist', 'Evasion Up', 'TM Gain',
            'Crit Chance Up', 'Crit Damage up'],
		...
		'BOBAFETT':['Ability Block', 'AoE', 'Bonus Attack', 'Counter',
            ...
            'Leader: +Crit Damage', 'Leader: +Crit Chance',
		...
		'CANDEROUSORDO':['AoE', 'Bonus Attack', 'DoT', 'TM Gain',
            'Offense Down', 'Tenacity Down', 'Crit Chance Up',
            'Crit Damage Up'],
		...
		'CARTHONASI':['AoE', 'Assist', 'DoT', 'TM Gain', 'Leader: +Tenacity',
            'Leader: Assist', 'Leader: Crit Avoid', 'Offense Up',
            'CD Reset'],
		...
		'CC2224':['Assist', 'TM Gain', 'Leader: +Crit Chance',
            'Leader: +Defense', 'Stun', 'CD Reduction'],
		'CHEWBACCALEGENDARY':['AoE', 'Assist', 'Mass Dispel', 'Offense Up',
            'Crit Chance Up', 'CD Reset', 'Stun', 'Tenacity Down'],
		'CHIEFCHIRPA':['Assist', 'Counter', 'TM Gain', 'Heal',
            'Leader: Assist', 'Speed Up'],
		'CHIEFNEBIT':['Assist', 'Leader: +Crit Chance', 'Stealth', 'Taunt',
            'Protection Up', 'CD Reduction', 'Crit Chance Down'],
		...
		'COLONELSTARCK':['AoE', 'Defense Down', 'Dispel', 'TM Gain', 'TMR',
            'Crit Chance Up', 'Crit Damage Up', 'Stagger', 'CD Reduction'],
		...
		'DARTHREVAN':['AoE', 'Assist', 'Bonus Attack',
            ...
            'Leader: +Crit Chance', 'Leader: +Crit Damage', 'Leader: +Speed',
            'CD Reduction', 'Stun', 'Shock', 'Fear', 'Deathmark'],
		'DARTHSIDIOUS':['AoE', 'Counter', 'DoT', 'Expose', 'TM Gain',
            'Heal Immunity', 'Leader: +Crit Chance'],
		...
		'DARTHTRAYA':['Ability Block', 'Counter', 'Daze', 'Dispel',
            ...
            'Leader: +Crit Avoid', 'Leader: +Potency', 'Cleanse'],
		...
		'DIRECTORKRENNIC':['Ability Block', 'AoE', 'Assist', 'Buff Immunity',
            'Leader: +Crit Chance', 'Revive', 'Speed Down', 'Stun',
		...
		'GENERALSKYWALKER':['AoE', 'Counter', 'Daze', 'Cleanse', 'TM Gain',
            ...
            'Leader: +Crit Damage', 'Stats Stacking', 'Crit Immunity'],
		...
		'GEONOSIANBROODALPHA':['AoE', 'Assist', 'Counter', 'Dispel', 'Expose',
            ...
            'Taunt', 'Mass Dispel', 'Summon', 'Crit Damage Up', 'Heal',
		...
		'GEONOSIANSPY':['AoE', 'Counter', 'Dispel', 'Evasion Down', 'Expose',
            'TM Gain', 'Potency Up', 'Stealth', 'Crit Chance Up', 'Cleanse',
            'CD Reduction'],
		...
		'GRANDMASTERYODA':['AoE', 'Foresight', 'TM Gain',
            ...
            'Protection Up', 'Leader: +Crit Chance', 'Leader: +Crit Damage'],
		'GRANDMOFFTARKIN':['AoE', 'Defense Down', 'Expose', 'TM Gain',
            'Leader: +Speed', 'Offense Down', 'Potency Up',
            'TMR', 'Stats Stacking', 'Crit Chance Down'],
		'GREEDO':['AoE', 'Bonus Attack', 'Counter', 'Dispel', 'TM Gain',
            'Potency Up', 'TMR', 'Stun', 'Thermal Detonator', 'Crit Chance Up',
            'Leader: +Crit Damage'],
		'GREEFKARGA':['Assist', 'Counter', 'Daze', 'Dispel', 'TM Gain',
            'Leader: +Crit Chance', 'Offense Up', 'Stealth', 'Tenacity Up',
            'Crit Damage Up', 'Crit Chance Up', 'Mass Cleanse', 'Heal',
            'CD Reduction', 'Leader: +Max Protection', 'Leader: +Offense'],
		'HANSOLO':['Counter', 'Evasion Up', 'TM Gain', 'TMR', 'Stun', 'Taunt',
        'Crit Chance Up', 'Crit Damage Up', 'Bonus Attack', 'Bonus Turn'],
		...
		'HK47':['AoE', 'Counter', 'Dispel', 'TM Gain', 'Leader: +Crit Chance',
            'Offense Up', 'CD Reset', 'Tenacity Down', 'True Damage',
            'CD Reduction', 'Leader: +Crit Damage'],
		...
		'BADBATCHHUNTER':['AoE', 'Bonus Attack', 'Counter', 'Defense Up',
            ...
            'Stealth', 'Stun', 'Target Lock', 'Crit Chance Up',
		...
		'IG88':['Ability Block', 'AoE', 'Defense Down', 'DoT', 'Heal Immunity',
            'Leader: +Crit Chance', 'Target Lock'],
		...
		'JANGOFETT':['AoE', 'Counter', 'Dispel', 'TM Gain', 'Heal Immunity',
            'Leader: +Crit Chance', 'Leader: +Speed', 'Leader: +Tenacity',
		...
		'ANAKINKNIGHT':['Advantage', 'AoE', 'Buff Immunity', 'Dispel',
            'Heal Immunity', 'Offense Up', 'Crit Chance Up', 'Protection Up',
            'Mass Dispel', 'Leader: +Offense', 'Leader: +Crit Damage',
            'Bonus Turn'],
		'JEDIKNIGHTGUARDIAN':['Ability Block', 'AoE', 'Defense Up',
            'Offense Down'],
		'JEDIKNIGHTLUKE':['AoE', 'Assist', 'Counter', 'Dispel', 'TM Gain',
            'Leader: +Crit Chance', 'Leader: +Speed', 'Leader: Assist', 'Stun',
            'Vulnerable', 'Blind', 'Leader: +Crit Damage'],
		'JEDIKNIGHTREVAN':['Ability Block', 'Advantage', 'AoE', 'Assist',
            ...
            'Mass Cleanse', 'Heal', 'Crit Damage Up', 'TM Swap', 'Mark',
            'CD Increase', 'TMR', 'Leader: +Crit Chance', 'Cleanse',
            'Crit Immunity', 'Bonus Turn'],
		'GRANDMASTERLUKE':['Ability Block', 'Advantage', 'AoE', 'Assist',
            ...
            'Tenacity Down', 'Tenacity Up', 'Mass Cleanse', 'Crit Chance Up',
            'Crit Damage Up', 'CD Increase', 'Breach', 'Crit Immunity',
            'Leader: +Max Protection', 'Leader: +Offense', 'Cleanse',
            'Defense Up', 'True Damage'],
		'JOLEEBINDO':['Assist', 'Dispel', 'TM Gain', 'Revive', 'CD Reduction',
            'Heal', 'Cleanse', 'Crit Immunity', 'Protection Up'],
		...
		'ADMINISTRATORLANDO':['AoE', 'Leader: +Speed', 'CD Reset',
            'Leader: +Crit Damage', 'Crit Chance Up'],
		...
		'LUMINARAUNDULI':['Ability Block', 'Evasion Up', 'Heal',
            'Leader: +Evasion'],
		'MACEWINDU':['Dispel', 'Expose', 'TM Gain', 'Leader: +Crit Chance',
            'Leader: +Offense'],
		...
		'PRINCESSLEIA':['Bonus Attack', 'Foresight', 'TM Gain',
            'Leader: +Crit Chance', 'Offense Up', 'Stealth', 'Crit Damage Up',
            'Crit Chance up'],
		'QIRA':['AoE', 'Assist', 'Counter', 'Daze', 'Dispel', 'Expose',
            'TM Gain', 'Leader: +Crit Chance', 'Leader: +Speed', 'Offense Down',
		...
		'HOTHLEIA':['Ability Block', 'Buff Immunity', 'Counter', 'Foresight',
            'TM Gain', 'Leader: +Crit Chance', 'Leader: +Tenacity',
            'CD Reduction'],
		...
		'SABINEWRENS3':['AoE', 'Counter', 'Expose', 'Offense Up',
            'CD Reduction', 'Armor Shred', 'Stagger', 'Crit Chance Up'],
		...
		'SHAAKTI':['Assist', 'Counter', 'Dispel', 'TM Gain',
            ...
            'Crit Chance Up', 'Crit Immunity', 'Leader: +Max Protection',
            'Leader: +Offense'],
		'SHORETROOPER':['Counter', 'TM Gain', 'Heal', 'Taunt',
            'Crit Chance Down', 'Crit Immunity', 'CD Reduction', 'Pre Taunt'],
		...
		'FOSITHTROOPER':['Advantage', 'AoE', 'Assist', 'Mass Cleanse',
            'CD Reset', 'Stun', 'Crit Immunity', 'Bonus Turn'],
		'SNOWTROOPER':['Ability Block', 'AoE', 'TM Gain', 'Crit Damage Up',
            'CD Reduction'],
		...
		'SUNFAC':['Counter', 'Daze', 'Defense Up', 'Dispel', 'Offense Down',
            'TMR', 'Taunt', 'Stagger', 'Blind', 'Crit Chance Down',
            'Health Up'],
		'SUPREMELEADERKYLOREN':['Advantage', 'AoE', 'Buff Immunity', 'Counter',
            ...
            'Mass Dispel', 'Mass Cleanse', 'Leader: +Crit Damage',
            'Crit Damage Up', 'Perma Death', 'Stats Stacking'],
		'T3_M4':['Ability Block', 'AoE', 'Cleanse', 'Offense Down',
            'Offense Up', 'TMR', 'Target Lock', 'Heal', 'Crit Immunity',
            'Mass Dispel', 'Crit Chance Down'],
		...
		'ARMORER':['Assist', 'Counter', 'Dispel', 'Armor Shred',
            'Protection Up', 'Crit Immunity'],
		'THEMANDALORIAN':['Assist', 'TM Gain',
            'Leader: +Crit Chance', 'Leader: +Speed', 'Leader: +Tenacity',
            'Revive', 'Crit Chance Up', 'Crit Damage Up', 'CD Reduction',
		...
		'WICKET':['AoE', 'Assist', 'TM Gain', 'Stealth', 'Crit Chance Up',
            'Crit Damage Up', 'Bonus Turn'],
		'YOUNGHAN':['Assist', 'Counter', 'Speed Down', 'Protection Up',
            'Crit Damage Up', 'Stats Stacking'],
...
ABILITY_CLASSES_LIST = [
    ...
    'Confuse', 'Counter', 'Crit Chance Down', 'Crit Chance Up',
    'Crit Damage Down', 'Crit Damage Up', 'Crit Immunity', 'Damage Immunity',
    ...
    'Health Equalization', 'Health Up', 'Insta Kill',
    'Leader: +Counter', 'Leader: +Crit Avoid',
    'Leader: +Crit Chance', 'Leader: +Crit Damage',
    ...
    'Leader: CD Reduction', 'Leader: Crit Avoid', 'Leader: Protection Up',
    'Leader: TM Gain', 'Leader: TMR', 'Mark', 'Mass Cleanse',
    'Mass Dispel', 'Offense Down', 'Offense Up', 'Passive', 'Perma Death',
    'Potency Down', 'Potency Up', 'Pre Taunt', 'Protection Up', 'Revive',
    'Shock', 'Speed Down', 'Speed Up', 'Stagger', 'Stats Sharing',
    'Stats Stacking', 'Stealth', 'Stun', 'Summon', 'TM Gain', 'TM Swap',
    'TMR', 'Target Lock', 'Taunt', 'Tenacity Down', 'Tenacity Up',
